...
namespace CRUD_Upload_file.Controllers
{
    public class SupportController : Controller
    {
        ...
        public ActionResult Edit(int? id)
        {
            ...
            Support support = db.Supports.Include(x => x.FileDetails).SingleOrDefault(x => x.SupportId == id);
            if (support == null)
            {
                return HttpNotFound();
            }
